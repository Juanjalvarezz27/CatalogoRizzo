        ...
        <main className="flex flex-1 flex-col items-center justify-center px-4 py-16 sm:px-6 relative z-10">
          ...
          <div className="mb-12 flex flex-col items-center text-center">
            <div className="relative mb-6">
              <div className="absolute -inset-3 rounded-full bg-gold-400/20 blur-xl animate-pulse-gold"></div>
              <img
                src="/Logo.jpg"
                alt="Licorería Rizzo"
                className="relative h-28 w-28 rounded-full object-cover ring-2 ring-gold-400/50 shadow-2xl shadow-gold-900/50 sm:h-36 sm:w-36"
              />
            </div>
          ...
          <div className="grid w-full max-w-3xl gap-6 sm:grid-cols-2">
            ...
            <a
              ...
              className="group relative overflow-hidden rounded-3xl bg-night-900/50 p-1 ring-1 ring-gold-900/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#25D366]/20 hover:ring-[#25D366]/50"
            >
              ...
              <div className="relative flex h-full flex-col items-center justify-center rounded-[22px] bg-night-900/80 p-8 backdrop-blur-xl transition-colors group-hover:bg-night-900/40">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative overflow-hidden rounded-3xl bg-night-900/50 p-1 ring-1 ring-gold-900/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#E1306C]/20 hover:ring-[#E1306C]/50"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-[#E1306C]/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
          ...
          <div className="mt-12 flex flex-col items-center">
            ...
            <Link
              href="/"
              className="group flex items-center gap-3 rounded-full bg-night-800/40 px-8 py-3.5 font-poppins text-sm font-semibold text-gold-400 ring-1 ring-gold-900/50 backdrop-blur-md transition-all duration-300 hover:bg-gold-400/10 hover:ring-gold-400/40"
            >
